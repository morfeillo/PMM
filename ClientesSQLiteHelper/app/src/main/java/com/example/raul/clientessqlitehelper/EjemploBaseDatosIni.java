...
public class EjemploBaseDatosIni extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView Cliente1 = (TextView)findViewById(R.id.Cliente1);
        final TextView Cliente2 = (TextView)findViewById(R.id.Cliente2);
...
/*
            ...
            //Ejemplo Select2
        		...
        		String[] args4 = new String[] {"Cliente1"};
        		...
        		if (c.moveToFirst()) {
        			...
        			do {
                        ...
                        Cliente1.setText(nombreCli);
        				String telefonoCli = c.getString(1);
                        Cliente2.setText(telefonoCli);
                        System.out.println(telefonoCli);
                       // Cliente1.append(nombreCli + " - " + telefonoCli + "\n");
        			} while (c.moveToNext());
